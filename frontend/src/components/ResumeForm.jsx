...
// // Function to improve content with AI
...
//     const response = await api.post('/api/resume/improve', {
//       current,
//       type,
//       industry
//     }, {
...
// export default function ResumeForm({ type, entries = [], onChange }) {
...
//           <CardHeader>
//             <CardTitle className="text-cyan-50">Add {type}</CardTitle>
//           </CardHeader>
...
//               />
//               <label htmlFor="current" className="text-cyan-50">Current {type}</label>
//             </div>
